        ...
        <div class="navbar">
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-content">
                    ...
                    <a href="DeleteCourse.html">Course</a>
                    <a href="DeleteContact.html">Contact</a>
                </div>
            </div>
...
<h3>See all Parents</h3>
		...
		<table>
            ...
            <label for="parentid">Delete Parent</label>
            ...
            if(isset($_POST['submit'])) {
                ...
                $sql = "DELETE FROM parent WHERE parentid = '$delparent'";
