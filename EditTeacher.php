...
<h3>Following are the stored teachers</h3>
		...
		<table>
			...
			<?php
			$sql = mysqli_query($link, "SELECT teacherid,name,address,phoneno,annual_salary,background_check FROM teacher");
            ...
            <label for="teacherid">Edit Teacher</label>
            ...
            if(isset($_POST['submit'])) {
                $delteacher = $_POST['teacherid'];
                $teachername = $_POST ['name'];
                $sql = "UPDATE teacher SET name='$teachername' WHERE teacherid='$delteacher'";
