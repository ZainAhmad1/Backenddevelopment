...
<h3>Following are the stored courses -::-</h3>
        ...
        <tr>
			...
			*/	
			$sql = mysqli_query($link, "SELECT courseid,name,credit_hour,course_code,duration FROM course");
            ...
            <label for="Courseid">Edit Course</label>
            ...
            if(isset($_POST['submit'])) {
                $delcourse = $_POST['courseid'];
                $coursename = $_POST ['name'];
                $sql = "UPDATE course SET name='$coursename' WHERE courseid='$delcourse'";
